...
-   ### Design
    -   #### Colour Scheme
        -   The main colours used are black, gray, and red provided by bootstrap, also I added some costum colors using scss variables.
    -   #### Typography
        -    I used the default bootstrap font-family "Helvetica Neue", Helvetica, Arial, sans-serif The font is used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly. I think this font is a clean and it is used frequently in programming, so it is both attractive and appropriate.
    -   #### Imagery
        -   Imagery is important. The large, background images are designed to be striking and catch the user's attention. I used the carousel so the main images will change every 5 seconds. They are all links to different pages (call action with bottoms).

*   ### Wireframes

    -   Home Page Wireframe - [View](assets/png_wireframe/home_wireframe2.0.png)
